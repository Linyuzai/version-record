...
import com.github.linyuzai.versionrecord.core.VersionPointScanPath;
...
@VersionPoint(description = "测试3", branch = "dev-01", date = "2020-03-02")
@EnableVersionRecord
...
public class VersionRecordApplication {
    ...
    @Bean
    VersionPointScanPath getScanPath() {
        return new VersionPointScanPath("com.github.linyuzai");
    }
}
